...
create or replace function private.save_visit_stock(p_device_id uuid, p_idempotency_key uuid, p_command jsonb)
returns jsonb
language plpgsql
volatile
security definer
...
revoke all on function private.save_visit_stock(uuid, uuid, jsonb) from public, anon, authenticated;
